...
Исходный код не исправлялся; существующие изменения документации и задач сохранены.
...
отдельным запуском тестов. Ссылки ниже относятся к финальному состоянию.
