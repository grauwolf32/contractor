...
![workflow](diagrams/pipelines.png)
...
- [trace_graph_pathpar/](../../contractor/workflows/trace_graph_pathpar/workflow.py) — `trace-graph-pathpar` (path-level parallel variant of `trace-graph`; identical annotation semantics, paths run concurrently over forked overlays — see [parallel vulnerability-pipeline insights](../insights/parallel-vulnerability-pipelines.md))
...
![streamline planner](diagrams/streamline-planner.png)
...
![subtask statuses](diagrams/subtask-statuses.png)
