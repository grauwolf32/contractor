...
| [V58-012](../../tasks/v58-012-release-verification.yml) | Verify and deploy the complete design review implementation | All 32; verification and release |
| [V58-013](../../tasks/v58-013-finding-text-and-run-actions.yml) | Restore full Finding descriptions and improve expanded history layouts | Post-release findings: full Markdown, sources, delete control, labels and allocation metrics |
| [V58-014](../../tasks/v58-014-configuration-navigation-and-credentials.yml) | Remove redundant configuration navigation and clarify credential inventory | Remove the shared panel; contextual links; managed and development credentials |
