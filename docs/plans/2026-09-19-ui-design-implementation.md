...
| [V58-014](../../tasks/v58-014-configuration-navigation-and-credentials.yml) | Remove redundant configuration navigation and clarify credential inventory | Удаление общей панели, контекстные ссылки, managed и development credentials |
...
V58-014 выполнена по уточнению пользователя: общая панель переходов удалена со всех пяти экранов; контекстные ссылки и пояснение managed/development credentials сохранены. Выпущен UI 0.3.3. [Доказательства](../../tasks/evidence/v58-014.json).
