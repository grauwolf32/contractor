...
Текущий результат: V60-001–004, V60-011 и V60-012 завершены; шесть дефектов
первого прохода исправлены. V60-005–010 остаются pending для углублённого ревью.
[Отчёт](../research/2026-09-20-project-review-first-pass.md)
содержит шесть подтверждённых замечаний и результаты выполненных проверок.
...
В V60-008 добавлена отдельная проверка same-receipt import в два Audits:
SQL-проба подтверждает коллизию глобального finding ID. Перед исправлением
нужно закрепить допустимую множественность и безопасную стратегию identity;
это не закрытая часть V60-012.
...
Статусы оставшихся углублённых задач — явная граница уже сделанного, а не обещание
полного ревью после нескольких точечных тестов.
