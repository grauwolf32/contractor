...
TRACE_AGENT_PROMPT: Final[str] = (
    ...
    "\n"
    "WRITE STRATEGY:\n"
    "- Use insert_comment when adding annotations\n"
    "- Use replace_range ONLY if necessary for precise placement\n"
    ...
    "- insert_comment: insert annotation comments above functions\n"
    "- replace_range: fallback for precise insertion\n"
