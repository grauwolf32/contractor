---
name: idor
description: IDOR / broken access control checklist — object ID enumeration, horizontal & vertical privilege escalation, GUID/UUID prediction, mass assignment, GraphQL/gRPC ID swaps, OAuth/MFA endpoints, presigned-URL abuse, OPA/Cedar policy fuzzing.
---

# Insecure Direct Object References (IDOR)

Trigger signals: object IDs in URL/body/cookies, ownership-bound resources, GraphQL `id:` args, mass-assignment-prone JSON, presigned URLs, BOLA, broken access control.
