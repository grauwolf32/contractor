---
name: ssrf
description: SSRF testing checklist — discovery, blind SSRF with OOB callbacks, cloud metadata (AWS IMDSv2 / GCP / Azure / Alibaba / Oracle / ECS / OpenStack), filter bypass (IP encoding, DNS rebinding, redirect chains, schema confusion), gopher/dict/file/jar abuse, K8s + service-mesh pivots.
---

# Server-Side Request Forgery (SSRF)

Trigger signals: URL/host/webhook input fields, "fetch from URL", PDF/screenshot export, image/document import, integration webhooks, allow/deny-listed domains, internal-IP filtering.
