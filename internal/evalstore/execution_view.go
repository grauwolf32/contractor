...
SELECT m.member_id,m.pair_id,m.ordinal,m.suite_id,m.case_id,m.sample,m.variant_id,m.eligibility,m.execution_kind,m.case_sha256,m.binding_sha256,
...
WHERE e.owner_id=$1 AND e.experiment_id=$2 ORDER BY m.ordinal LIMIT 10001
`, owner, id)
	if err != nil {
		return nil, err
	}
