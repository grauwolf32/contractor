...
func MVPDescriptors() Descriptors {
	return Descriptors{
		...
		Toolsets: map[string]ToolsetDescriptor{
			...
			"scan@1": {
				Tools: []string{"scan_ffuf", "scan_katana", "scan_naabu", "scan_nuclei", "scan_sqlmap"},
				InfrastructureChannels: map[string][]ToolInfrastructureChannel{
					"scan_ffuf":   {RuntimeSubprocessLauncher},
					"scan_katana": {RuntimeSubprocessLauncher},
					"scan_naabu":  {RuntimeSubprocessLauncher},
					"scan_nuclei": {RuntimeSubprocessLauncher},
					"scan_sqlmap": {RuntimeSubprocessLauncher},
				},
				ActiveCheckTools: []string{"scan_ffuf", "scan_katana", "scan_naabu", "scan_nuclei", "scan_sqlmap"},
			},
			"source-analysis@1": {
