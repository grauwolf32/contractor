...
func TestAuditCompletionPostgresAtomicCreationRestartAndAllocation(t *testing.T) {
	...
	allocation := runstore.StageAllocation{AllocationID: "allocation", StageExecutionID: executionStage.StageExecutionID, LogicalAgentName: "checker", Namespace: "audit-check", AgentTemplateRef: agent.Template.Ref, WorkerRuntimeRef: agent.Template.Runtime, RuntimeAgentID: strings.Repeat("1", 64), RuntimeAgentInstanceID: "runtime", RuntimeAgentLabelRevision: 1, RuntimeConfigurationSchemaVersion: runstore.AllocationRuntimeConfigurationSchemaVersion, PerformanceCollectionPolicy: contracts.PerformanceCollectionDisabled, RuntimeConfiguration: &runstore.AllocationRuntimeConfiguration{ModelPolicy: stage.ExecutionConfig.Agents["checker"].ModelPolicy.Ref, Origins: runtimeconfig.ResolvedRuntimeConfigOrigins{}, Provenance: contracts.ResolvedRuntimeConfigProvenanceV2{Default: contracts.RuntimeLabelBindingProvenanceV2{Label: "default", BindingRevision: 1, Config: contracts.RuntimeConfigRefV2{Name: runtimeconfig.BuiltInName, Version: runtimeconfig.BuiltInVersion, Digest: runtimeconfig.BuiltInDigest}}, RunLabels: []contracts.RuntimeLabelBindingProvenanceV2{}, AgentLabels: []contracts.RuntimeLabelBindingProvenanceV2{}, RuntimeAdapters: []contracts.RuntimeAdapterRef{}, RuntimeCredentialRefs: []contracts.RuntimeCredentialRefV2{}, LLMGatewayConfig: &gateway}}}
