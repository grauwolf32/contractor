...
func NewHandler(dependencies Dependencies) (http.Handler, error) {
	...
	mux.HandleFunc("GET /v1/audits/{auditId}/workspace", current.getAuditWorkspace)
	mux.HandleFunc("GET /v1/audits/{auditId}/reviews/{requestId}", current.getAuditReview)
	...
	mux.HandleFunc("POST /v1/finding-collections", current.publishFindingCollection)
	...
	mux.HandleFunc("GET /v1/configurations/agent-templates/{name}/versions/{version}/workflow-bindings", current.listAgentTemplateWorkflowBindings)
	...
	mux.HandleFunc("POST /v1/runs/{runID}/resume", current.resumeRun)
	mux.HandleFunc("DELETE /v1/runs/{runID}", current.deleteRun)
	mux.HandleFunc("GET /v1/runs/{runID}", current.getRun)
	mux.HandleFunc("GET /v1/runs/{runID}/repeat-draft", current.getRunRepeatDraft)
	...
	mux.HandleFunc("/v1/runs/{runID}/resume", current.methodNotAllowed)
	mux.HandleFunc("/v1/runs/{runID}/repeat-draft", current.methodNotAllowed)
	...
	mux.HandleFunc("/v1/configurations/agent-templates/{name}/versions/{version}/workflow-bindings", current.methodNotAllowed)
	...
	mux.HandleFunc("/v1/audits/{auditId}/workspace", current.methodNotAllowed)
	mux.HandleFunc("/v1/audits/{auditId}/reviews/{requestId}", current.methodNotAllowed)
	...
	mux.HandleFunc("/v1/finding-collections", current.methodNotAllowed)
