---
description: "CWE quick reference for the trace skill: map a confirmed finding to its CWE id before writing the finding details."
---

# CWE Quick Reference

Load this reference **before** writing the `details` field of a finding record.
