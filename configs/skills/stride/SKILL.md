---
name: stride
description: "Model code-anchored STRIDE threats by correlating architecture, API, dependency, project, and source evidence."
compatibility: "Contractor adk@1 native Agent Skill disclosure; requires project evidence in the Worker invocation context"
metadata:
...
5. **Model only — never verify exploitability.** Verification belongs to a
   separately authorized testing task, not this analysis procedure.
