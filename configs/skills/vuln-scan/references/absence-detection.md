...
class OrderView(APIView):
    ...
    def get(self, request):  # ← NO AUTH — vulnerability!
        ...
```
**Detection**: inventory declarations in views.py with the available
source-navigation interface; for each class, read ALL method decorators. Flag methods without @jwt_auth_required when
siblings have it.
...
1. Inventory ALL functions/methods with the available source-navigation interface
2. Read the first 5-10 lines of each method and check decorators
