...
**How to check:** See the "CORS / Header misconfig" sink in `references/sink-patterns.md` for grep strings. Reflected-origin + credentials is the high-severity case; wildcard origin without credentials is informational.
