...
`examples/` contains copyable multi-Stage and bounded-retry Workflow manifests.
They are intentionally outside `workflows/`, so they document supported shapes
without changing the default end-to-end fixture.
