...
Group diagnostics sharing a root cause and preserve valid unrelated content and
evidence descriptions. Rejected or ambiguous edits require a targeted read and
corrected arguments, not an identical retry.
