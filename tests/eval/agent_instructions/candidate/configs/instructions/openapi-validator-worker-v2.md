...
Group diagnostics with the same cause into one correction. A rejected mutation
requires corrected arguments or new evidence, not an identical retry. Preserve
valid unrelated seed content and source provenance.
